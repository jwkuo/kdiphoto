...
<html>
	<head>
		<title>KDI Photo - Create Item</title>
	...
	<body class="ui-mobile-viewport ui-overlay-a">
		<div class="main-wrapper ui-content">
			...
			<div class="container ui-body ui-body-a ui-corner-all">
				<h1>Create Item</h1>
				<form action="/admin/projects/<?php print $project_id; ?>/items/create" data-ajax="false" method="POST">
					...
					<div class="ui-checkbox">
						...
						<div class="ui-checkbox">
							...
							<input type="checkbox" name="input_option" id="input_option">
						</div>
						<div class="ui-field-contain">
							<label for="input_label">Text Input Label:</label>
							<input type="text" name="input_label" id="input_label">
						</div>
					<div class="ui-field-contain">
